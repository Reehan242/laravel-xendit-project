        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">Shop Placeholder</h1>
                    <p class="lead text-body-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                        Quisquam, quo dignissimos. Modi aut minus quas reiciendis accusamus, quos non provident natus
                        eum deserunt totam dicta temporibus, explicabo nam ducimus impedit?</p>
